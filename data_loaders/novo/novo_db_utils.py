...
def generate_row_hash(row: pd.Series) -> str:
    ...
    columns_to_hash = ["Customer Number", "Invoice Number", "Sales Rep Name", "Invoice Date", "Extension", "Item Code"]
...
def save_dataframe_to_db(df: pd.DataFrame, table_name: str = "master_novo_sales"):
    """
    Save data to the 'master_novo_sales' table by removing entries based on 'Commission Date MM' and 'Commission Date YYYY'.
